...
public class StudentDaoImpl implements StudentDao {
    ...
    public void addStudentToCourse(int studentId, int courseId) {
        //YOUR CODE STARTS HERE
        final String INSERT_ENROLLMENT =
                "INSERT INTO course_student(student_id, course_id) VALUES(?, ?)";
        jdbcTemplate.update(INSERT_ENROLLMENT, studentId, courseId);
        //YOUR CODE ENDS HERE
    }
    ...
    public void deleteStudentFromCourse(int studentId, int courseId) {
        //YOUR CODE STARTS HERE
        final String DELETE_ENROLLMENT =
                "DELETE FROM course_student WHERE student_id = ? AND course_id = ?";
        jdbcTemplate.update(DELETE_ENROLLMENT, studentId, courseId);
        //YOUR CODE ENDS HERE
    }
}
